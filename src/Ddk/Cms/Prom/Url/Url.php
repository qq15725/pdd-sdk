...
class Url extends BaseClient
{
     ...
     * @return array
     */
    public function generate(array $pIdList, ?int $channelType = null, $query = [])
    {
        $query += [
            'p_id_list' => json_encode($pIdList),
            'channel_type' => $channelType
        ];

        return $this->httpPost('pdd.ddk.cms.prom.url.generate', $query);
    }
}